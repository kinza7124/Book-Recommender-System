...
# Load book metadata for rendering recommendation cards
...
# Load pivot table and similarity scores
pt_path = os.path.join(BASE_DIR, 'pt.pkl')
sim_path = os.path.join(BASE_DIR, 'similarity_scores.pkl')
pt = pickle.load(open(pt_path, 'rb'))
similarity_scores = pickle.load(open(sim_path, 'rb'))

# Fast lookup for title matching
...
if __name__ == '__main__':
    # Listen on 0.0.0.0:7860 for Hugging Face Spaces
